...
export const GameModal: React.FC<GameModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md p-2 sm:p-4">
      <div
        ref={containerRef}
        className="relative w-full max-w-6xl h-[92vh] max-h-[900px] flex flex-col bg-[#0b0e17] border border-casino-border rounded-2xl overflow-hidden shadow-2xl"
      >
        {/* Top Control & Status Bar */}
        <div className="h-14 px-4 bg-[#101522] border-b border-casino-border flex items-center justify-between shrink-0">
          {/* Game Title & Provider */}
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-2 bg-[#090d16] border border-casino-border px-3 py-1.5 rounded-xl">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-black text-xs font-bold transition-all shadow-emerald-glow"
            >
          ...
          <div className="flex items-center gap-2">
            {launchUrl && !isNativeRoyal && (
              <a
                ...
                className="hidden sm:flex items-center gap-1 px-3 py-1.5 rounded-xl bg-casino-card hover:bg-casino-cardHover border border-casino-border text-xs font-bold text-amber-300 hover:text-amber-200 transition-colors"
            ...
            <button
              ...
              className="p-2 rounded-xl bg-casino-card hover:bg-casino-cardHover border border-casino-border text-gray-300 hover:text-white transition-colors"
